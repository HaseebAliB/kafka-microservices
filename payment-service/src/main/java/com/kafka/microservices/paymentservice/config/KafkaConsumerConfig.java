...
import com.kafka.microservices.common.NotRetryableException;
import com.kafka.microservices.common.RetryableException;
...
public class KafkaConsumerConfig {
    ...
    ConcurrentKafkaListenerContainerFactory<String, Object> kafkaListenerContainerFactory(
        ...
        errorHandler.setRetryListeners((record, ex, deliveryAttempt) -> {
            log.error("Payment Message Processing Error (attempt {} of {}): key={}, value={}, topic={}, exception={}",
                    deliveryAttempt, 3, record.key(), record.value(), record.topic(), ex.toString(), ex);
        });
